...
class _SnakeIoProState extends State<SnakeIoPro> {
  ...
  dynamic _yandexAd; // لتجنب تعارض الكلاسات أثناء البناء
  ...
  void _loadAds() {
    ...
    } catch (e) { debugPrint("Yandex Load Error: $e"); }
  }
